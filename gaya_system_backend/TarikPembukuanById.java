...
public class TarikPembukuanById implements HttpHandler {
	@Override
	public void handle(HttpExchange exchange) throws IOException {
		try {
			...
			String sql = "select * from pembukuan where pid = '"+ q.get("pid") +"'";
			...
			while (rs.next()) {
				...
				response = id + " | " + tanggal + " | " + keterangan + " | " + debit + " | " + kredit + " | " + saldo + " | ";
			}
			br.close();
